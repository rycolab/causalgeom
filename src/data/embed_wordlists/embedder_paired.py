...
def get_wordlist_paths(concept):
    if concept == "number":
        ...
        return None, CEBAB_AMBIANCE_ADJ_LIST_PATH
    elif concept == "noise":
        return None, CEBAB_NOISE_ADJ_LIST_PATH
    elif concept == "service":
        return None, CEBAB_SERVICE_ADJ_LIST_PATH
    else:
...
def get_emb_outfile_paths(concept, model_name):
    if concept == "number":
        ...
        return None, None, l0_emb_outfile, l1_emb_outfile
    else:

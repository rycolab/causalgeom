...
def get_train_probes_args():
    ...
    argparser.add_argument(
        "-source",
        type=str,
        choices=["natural_concept", "gen_ancestral_concept", 
                 "gen_nucleus_concept", "gen_ancestral_all", 
                 "gen_nucleus_all"],
        help=("Which samples to use for eval."
             "natural: test set samples from LEACE training data"
...
def set_train_probes_defaults(config):
    ...
    #config["train_obs"] = 10000
    #config["val_obs"] = 1000
    #config["test_obs"] = 1000
